package com.example.cataractpredict.utils
...
object EventDummy {
    ...
    fun generateDummyEvent(): List<ArticleEntity> {
        ...
        article.add(
            ArticleEntity(
                ...
                "Pernah merasa mata perih dan muncul sensasi seperti terbakar? Sebenarnya, kondisi ini kurang lazim terjadi dan sangat mungkin hal ini menjadi tanda dari salah satu masalah kesehatan tertentu. Lantas, apa saja ya penyebab mata perih?\n" +
                        ...
                        "Berikut ini beberapa kondisi yang bisa menjadi penyebab mata perih dan terasa seperti terbakar.\n" +
                        "\n" +
                        "1. Blepharitis\n" +
                        "Blepharitis adalah infeksi atau peradangan yang terjadi di kelopak mata, kondisi ini ditandai dengan kemunculan kerak, kemerahan atau kulit kering seperti ketombe di dasar kelopak atau bulu mata.\n" +
                        "\n" +
                        ...
                        "Anda juga perlu menjaga kebersihan bulu-bulu mata setiap hari dengan sampo bayi agar tidak perih.\n" +
                        "\n" +
                        "2. Mata kering\n" +
                        ...
                        "\n" +
                        "Anda bisa menggunakannya kapan pun dibutuhkan saat mata terasa kering dan juga perih.\n" +
                        "\n" +
                        "3. Alergi\n" +
                        "Alergi pada mata atau yang disebut juga dengan konjungtivitis terjadi ketika ada zat asing yang masuk ke mata. Tubuh kemudian merespon zat ini dengan memproduksi histamin.\n" +
                        "\n" +
                        "Histamin adalah zat yang diproduksi tubuh ketika Anda mengalami reaksi alergi atau infeksi. Akibatnya, mata menjadi kemerahan dan gatal.\n" +
                        "\n" +
                        ...
                        "\n" +
                        "Alergi pada mata bisa diatasi dengan menambahkan kelembapan dengan obat tetes mata.\n" +
                        "\n" +
                        "Selain itu, dokter juga biasanya akan meresepkan dekongestan untuk mengurangi kemerahan dan antihistamin minum untuk mengurangi rasa gatal.\n" +
                        "\n" +
                        "Tetes mata steroid juga bisa diresepkan untuk membantu mengobati gejala alergi mata yang kronis dan berat.\n" +
                        "\n" +
                        "4. Terbakar sinar matahari\n" +
                        "Paparan sinar matahari yang berlebih pada mata bisa menyebabkan sensasi terbakar yang dikenal dengan nama fotokeratitis.\n" +
                        "\n" +
                        ...
                        "\n" +
                        "5. Ocular rosacea\n" +
                        "Ocular rosacea adalah kondisi yang menyebabkan kelopak mata meradang. Biasanya, penyakit yang satu ini menyerang orang-orang yang memiliki acne rosacea.\n" +
                        "\n" +
                        ...
                        "\n" +
                        "6. Pterigyum\n" +
                        "Pterigyum adalah tumbuhnya jaringan daging di bagian mata yang berwarna putih. Biasanya, daging ini muncul di bagian mata yang mendekati hidung atau bisa juga muncul di bagian terluar mata.\n" +
                        "\n" +
                        "Para ahli memperkirakan kondisi ini disebabkan oleh kombinasi mata kering dan paparan sinar UV.\n" +
                        "\n" +
                        "Biasanya gejala pterigyum yang akan muncul yaitu sensasi terbakar pada mata, gatal, kemerahan, dan juga pembengkakan.\n" +
                        "\n" +
                        "Dalam kasus yang lebih parah, pertumbuhan jaringan daging ini bisa melebar dan menutupi kornea hingga mengganggu penglihatan.\n" +
                        "\n" +
                        "Jika Anda memiliki pterigyum, segera konsultasikan ke dokter. Biasanya dokter akan mengobati berbagai ketidaknyamanan yang Anda alami dengan memberikan tetes mata pelumas atau steroid.\n" +
                        "\n" +
                        "Namun, jika pterigyum tumbuh cukup besar dan melebar maka dokter akan merekomendasikan untuk menghilangkannya dengan operasi.\n" +
                        "\n" +
                        "Dokter akan mentransplantasikan jaringan tipis normal ke area tumbuhnya jaringan. Teknik ini membantu mengurangi kemungkinan jaringan tumbuh kembali di kemudian hari.\n" +
                        "\n" +
                        "Selain itu, Anda juga perlu menghindari mata dari kekeringan, paparan sinar matahari berlebih, dan juga debu.\n" +
                        "\n" +
